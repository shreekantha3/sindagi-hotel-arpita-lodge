# Hotel Arpita Lodge — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-hotel-arpita-lodge/
- **Repo:** `shreekantha3/sindagi-hotel-arpita-lodge` (branch `main` = source, `gh-pages` = deployed bundle)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-hotel-arpita-lodge/'` for GitHub Pages project-site hosting.
