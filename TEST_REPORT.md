# TEST REPORT — Hotel Arpita Lodge
> Tester: Senior Engg | Segment: Lodge | Tier-4/5

## Build
- [ ] `npm run build` (pending)

## Static QA (generator asserts)
- Phone: `tel:+918971593376` + WhatsApp | Maps embed (lazy iframe) + JSON-LD Hotel schema + H1 + title<=60
- No lorem ipsum, no invented hours/prices/ratings

## Build result (2026-09-15)
- [x] `npm run build` PASS (vite 5.4.21, 0 warnings)
- dist: index 11.95 kB / CSS 11.51 kB / JS 1.17 kB — under perf budget
